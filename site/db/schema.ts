...
export const customers = sqliteTable(
  ...
  (table) => [
    ...
    index("customers_created_id_idx").on(table.createdAt, table.id),
    index("customers_status_created_id_idx").on(table.status, table.createdAt, table.id),
...
export const subscriptions = sqliteTable(
  ...
  (table) => [
    ...
    index("subscriptions_created_id_idx").on(table.createdAt, table.id),
    index("subscriptions_status_created_id_idx").on(table.status, table.createdAt, table.id),
...
export const invoices = sqliteTable(
  ...
  (table) => [
    ...
    index("invoices_created_id_idx").on(table.createdAt, table.id),
    index("invoices_status_created_id_idx").on(table.status, table.createdAt, table.id),
...
export const discounts = sqliteTable(
  ...
  (table) => [
    ...
    index("discounts_active_created_id_idx").on(table.active, table.createdAt, table.id),
...
export const promotionCodes = sqliteTable(
  ...
  (table) => [
    ...
    index("promotion_codes_active_created_id_idx").on(table.active, table.createdAt, table.id),
...
export const auditEvents = sqliteTable(
  ...
  (table) => [
    ...
    index("audit_events_created_id_idx").on(table.createdAt, table.id),
...
export const notificationDeliveries = sqliteTable(
  ...
  (table) => [
    ...
    index("notification_deliveries_created_id_idx").on(table.createdAt, table.id),
    index("notification_deliveries_status_created_id_idx").on(table.status, table.createdAt, table.id),

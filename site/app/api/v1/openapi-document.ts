...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/customer/account": { get: { tags: ["Customer"], security: sessionSecurity, summary: "Get the signed-in customer account", responses: { "200": response("Customer account"), "401": response("Authentication required"), "403": response("Forbidden") } } },

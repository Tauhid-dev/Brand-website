...
export default async function AdminDashboardPage() {
  ...
  return <PortalShell kind="Admin" title="Commercial operations" subtitle="Customers, fulfilment, billing and agent provisioning in one controlled workspace." user={principal.displayName}>
    <MetricGrid items={[["Customers", dashboard.metrics.customers], ["Current subscriptions", dashboard.metrics.currentSubscriptions], ["Onboarding attention", dashboard.metrics.onboardingAttention], ["Open invoices", dashboard.metrics.openInvoices], ["Queue items", dashboard.metrics.openQueueItems]]} />
    <Panel title="Operational queues"><DataTable rows={dashboard.queues} columns={[["queueType", "Queue"], ["title", "Item"], ["status", "Status"], ["priority", "Priority"], ["dueAt", "Due"]]} /></Panel>

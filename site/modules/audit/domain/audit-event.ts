...
export const AUDIT_ACTIONS = {
  ...
  billingProviderPriceLinked: "BILLING_PROVIDER_PRICE_LINKED",
  billingCheckoutCreated: "BILLING_CHECKOUT_CREATED",
  billingCheckoutCompleted: "BILLING_CHECKOUT_COMPLETED",
  billingProviderSubscriptionSynchronized: "BILLING_PROVIDER_SUBSCRIPTION_SYNCHRONIZED",
  ...
  standaloneLoginSuccess: "STANDALONE_LOGIN_SUCCESS",
  standaloneLoginFailed: "STANDALONE_LOGIN_FAILED",
  standaloneLogout: "STANDALONE_LOGOUT",
